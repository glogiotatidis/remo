...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        ContentType.objects.filter(app_label='reports', model='report').delete()
        ContentType.objects.filter(app_label='reports', model='reportcomment').delete()
        ContentType.objects.filter(app_label='reports', model='reportlink').delete()
        ContentType.objects.filter(app_label='reports', model='reportevent').delete()
